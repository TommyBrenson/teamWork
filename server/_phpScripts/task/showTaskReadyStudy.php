<?php
    ...
    if (!$conn) {
        die("<script>alert('Connection Failed.')</script>");
            ...
            $sql = "SELECT * FROM `taskstudy` WHERE `id_user`= $id_user AND `ready_task`= 1";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                <li class="list-group-item">
                    ...
                    <button type="submit" id="removeBtnRStudy" class="btn btn-warning float-left" data-id="<?php echo $row['id_task']; ?>"><i class="fa fa-arrow-left"></i></button>
